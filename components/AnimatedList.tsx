    ...
    <div className={`relative w-[500px] ${className}`}>
      <div
        ...
        className={`max-h-[400px] overflow-y-auto p-4 ${
          displayScrollbar
            ? "[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-[#0a0a0a] [&::-webkit-scrollbar-thumb]:bg-[#0a0a0a] [&::-webkit-scrollbar-thumb]:rounded-[4px]"
            : "scrollbar-hide"
        }`}
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className= {`p-4 bg-[#1e1d1f] rounded-lg ${selectedIndex === index ? "bg-[#0a0a0a]" : ""} ${itemClassName}`}
            >
